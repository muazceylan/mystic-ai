package com.mysticai.astrology.security;
...
public class GatewayTrustFilter extends OncePerRequestFilter {
    ...
    public GatewayTrustFilter(MeterRegistry meterRegistry) {
        this.rejectedGatewayTrustCounter = Counter.builder("security.astrology.gateway_trust_rejected")
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !(path.startsWith("/api/v1/daily/")
                || path.startsWith("/api/v1/cosmic-planner/")
    ...
    protected void doFilterInternal(
        ...
        if (providedKey == null || !providedKey.equals(internalGatewayKey)) {
            log.warn("Blocked astrology request without valid gateway trust key: method={} path={} ip={}",
