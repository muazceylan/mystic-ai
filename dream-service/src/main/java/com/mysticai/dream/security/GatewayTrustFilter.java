package com.mysticai.dream.security;
...
public class GatewayTrustFilter extends OncePerRequestFilter {
    ...
    public GatewayTrustFilter(MeterRegistry meterRegistry) {
        this.rejectedGatewayTrustCounter = Counter.builder("security.dream.gateway_trust_rejected")
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !(path.equals("/api/v1/dreams") || path.startsWith("/api/v1/dreams/"));
    }
    ...
    protected void doFilterInternal(
        ...
        if (providedKey == null || !providedKey.equals(internalGatewayKey)) {
            log.warn("Blocked dream request without valid gateway trust key: method={} path={} ip={}",
