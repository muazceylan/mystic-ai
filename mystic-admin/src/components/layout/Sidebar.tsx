...
import { LayoutDashboard, Bell, Map, ClipboardList, LogOut, Star, Layers, Navigation, Users, GitMerge, Sun, CalendarDays, BookOpen, Library, Zap, History, Type, Home, Compass, CreditCard, Image, Coins, ScrollText, Wand2, ShoppingBag, Wallet, FlaskConical, BarChart3, Bot, Hash, Receipt, ShieldCheck, Smartphone } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/app-version', label: 'Mobile App Version', icon: Smartphone, check: canManageRoutes },
  ...
  { href: '/monetization/purchase-events', label: 'Purchase Events', icon: Receipt, check: canManageRoutes },
  { href: '/monetization/user-entitlements', label: 'User Entitlements', icon: ShieldCheck, check: canManageRoutes },
