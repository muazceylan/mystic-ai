  ...
  return (
    <AdminLayout>
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-white flex-1">Modül Kuralı Düzenle</h1>
      ...
      <div className="max-w-2xl">
        <form onSubmit={handleSubmit(submitForm)} className="space-y-5 bg-gray-900 border border-gray-800 rounded-xl p-6">
          ...
          <div className="border border-purple-800/60 rounded-lg p-4 space-y-4 bg-purple-950/20">
            ...
            <Controller name="rewardedAdEnabled" control={control} render={({ field }) => <Checkbox label="Rewarded Ad Enabled" checked={!!field.value} onChange={field.onChange} />} />
            <div>
      ...
      <Modal open={deleteModal} onClose={() => setDeleteModal(false)} title="Kuralı Sil">
        <p className="text-gray-300 text-sm mb-6">Bu modül kuralını kalıcı olarak silmek istediğinize emin misiniz?</p>
