...
export default function NightSkyPosterPreviewScreen() {
  ...
  const handleShare = async () => {
    if (isWeb) {
      const shareTarget = resolvedShareUrl ?? draft?.shareUrl;
      if (!shareTarget) {
        Alert.alert(t('nightSkyPosterPreview.shareErrorTitle'), t('nightSkyPosterPreview.shareLinkError'));
        return;
      }
      await Linking.openURL(shareTarget);
      return;
    }
  ...
  const handleInstagram = async () => {
    if (isWeb) {
      Alert.alert(t('nightSkyPosterPreview.instagramErrorTitle'), t('nightSkyPosterPreview.unexpectedError'));
      return;
    }
  ...
  const handleSave = async () => {
    if (isWeb) {
      Alert.alert(t('nightSkyPosterPreview.saveErrorTitle'), t('nightSkyPosterPreview.unexpectedError'));
      return;
    }
  ...
  const handleExportPdf = async () => {
    if (isWeb) {
      Alert.alert(t('nightSkyPosterPreview.pdfErrorTitle'), t('nightSkyPosterPreview.unexpectedError'));
      return;
    }
