...
export default function LanguageSettingsScreen() {
  ...
  const handleSelect = async (lang: string) => {
    ...
    try {
      ...
      // Local selection is already applied even if remote update fails.
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <SafeScreen>
      <View style={S.container}>
        <TabHeader title={t('language.title')} />
            ...
            {LANGUAGES.map((lang, index) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  accessibilityLabel={t('language.selectAccessibility', { language: t(lang.titleKey) })}
