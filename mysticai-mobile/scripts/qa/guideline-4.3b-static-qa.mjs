...
for (const event of [
  ...
  'personal_plan_primary_action_completed',
  'personal_plan_why_opened',
  'personal_plan_feedback_submitted',
  'personal_plan_regenerated',
  'personal_plan_life_area_opened',
  'personal_plan_evening_reflection_viewed',
