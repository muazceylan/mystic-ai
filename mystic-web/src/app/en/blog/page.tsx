...
export const metadata: Metadata = {
  title: 'Blog — Astrology, Numerology & Spiritual Guidance Articles',
  description:
    'AstroGuru blog: informative articles and guides about astrology, numerology, dream interpretation and spiritual guidance.',
  alternates: getMetadataAlternates('en', '/blog'),
};
...
export default async function BlogPageEn() {
  const posts = await fetchAllPosts('en');
      ...
      <section className="bg-gradient-to-b from-purple-950 to-zinc-950 py-16 text-white sm:py-20">
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-purple-200">
            Informative articles about astrology, numerology, dream
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          {posts.length > 0 ? (
            ...
            <div className="rounded-2xl border border-dashed border-zinc-300 p-8 text-center dark:border-zinc-700">
              <h2 className="text-xl font-semibold">English articles are coming soon</h2>
              <p className="mt-3 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                We only publish localized posts here once the full English version is ready.
                Until then, you can explore the English feature pages across the site.
              </p>
            </div>
          )}
        </div>
