...
public class GatewayTrustFilter extends OncePerRequestFilter {
    ...
    public GatewayTrustFilter(MeterRegistry meterRegistry) {
        this.rejectedGatewayTrustCounter = Counter.builder("security.notification.gateway_trust_rejected")
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !(path.equals("/api/v1/notifications") || path.startsWith("/api/v1/notifications/"))
    ...
    protected void doFilterInternal(
        ...
        if (providedKey == null || !providedKey.equals(internalGatewayKey)) {
            log.warn("Blocked request without valid gateway trust key: method={} path={} ip={}",
