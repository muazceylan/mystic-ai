...
@Entity
@Table(name = "weekly_horoscope_cms",
        uniqueConstraints = @UniqueConstraint(
                name = "uq_weekly_horoscope_sign_week_locale",
                columnNames = {"zodiac_sign", "week_start_date", "locale"}
        ))
...
@NoArgsConstructor
@AllArgsConstructor
public class WeeklyHoroscopeCms {
    ...
    // Raw JSON snapshot from external API (preserved for reference)
    @Column(columnDefinition = "TEXT")
