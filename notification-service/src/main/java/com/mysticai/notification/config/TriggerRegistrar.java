    ...
    private void registerTriggers() {
        List<NotificationTrigger> triggers = List.of(
            ...
            NotificationTrigger.builder()
                ...
                .description("Her gün kullanıcının yerel saatiyle 08:30'da tüm aktif kullanıcılar için günlük özet bildirimi üretir.")
                ...
                .ownerModule("notifications")
                .codeReference("NotificationScheduler#generateUserLocalTimeNotifications")
                .build(),
            ...
            NotificationTrigger.builder()
                ...
                .description("Her gün kullanıcının yerel saatiyle 12:15'te numeroloji check-in bildirimlerini gönderir.")
                .cadenceType(NotificationTrigger.CadenceType.DAILY)
            ...
            NotificationTrigger.builder()
                ...
                .description("Her sabah kullanıcının yerel saatiyle 06:00'da dua hatırlatıcılarını gönderir.")
                .cadenceType(NotificationTrigger.CadenceType.DAILY)
            ...
            NotificationTrigger.builder()
                ...
                .description("Her sabah kullanıcının yerel saatiyle 07:30'da kozmik planlayıcı hatırlatıcılarını gönderir.")
                .cadenceType(NotificationTrigger.CadenceType.DAILY)
            ...
            NotificationTrigger.builder()
                ...
                .description("Her akşam kullanıcının yerel saatiyle 20:00'da meditasyon hatırlatıcılarını gönderir.")
                .cadenceType(NotificationTrigger.CadenceType.DAILY)
            ...
            NotificationTrigger.builder()
                ...
                .description("Her gün kullanıcının yerel saatiyle 14:00'te gün içi enerji güncelleme bildirimlerini gönderir.")
                .cadenceType(NotificationTrigger.CadenceType.DAILY)
            ...
            NotificationTrigger.builder()
                ...
                .description("Her gün kullanıcının yerel saatiyle 16:30'da mini içgörü bildirimlerini gönderir.")
                .cadenceType(NotificationTrigger.CadenceType.DAILY)
            ...
            NotificationTrigger.builder()
                ...
                .description("Her gece kullanıcının yerel saatiyle 21:00'da akşam check-in bildirimlerini gönderir.")
                .cadenceType(NotificationTrigger.CadenceType.DAILY)
            ...
            NotificationTrigger.builder()
                ...
                .description("Her Pazartesi kullanıcının yerel saatiyle 09:00'da haftalık özet bildirimlerini gönderir.")
            ...
            NotificationTrigger.builder()
                ...
                .description("Salı ve Cuma kullanıcının yerel saatiyle 10:00'da pasif kullanıcılara re-engagement bildirimi gönderir.")
                .cadenceType(NotificationTrigger.CadenceType.DAILY)
            ...
            NotificationTrigger.builder()
                ...
                .description("Çarşamba ve Cumartesi kullanıcının yerel saatiyle 18:30'da öne çıkan modülleri hatırlatan sistem bildirimlerini üretir.")
                .cadenceType(NotificationTrigger.CadenceType.WEEKLY)
