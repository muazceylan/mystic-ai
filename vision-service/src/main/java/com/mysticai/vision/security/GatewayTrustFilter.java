package com.mysticai.vision.security;
...
public class GatewayTrustFilter extends OncePerRequestFilter {
    ...
    public GatewayTrustFilter(MeterRegistry meterRegistry) {
        this.rejectedGatewayTrustCounter = Counter.builder("security.vision.gateway_trust_rejected")
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !(path.startsWith("/api/v1/vision/") || path.startsWith("/api/vision/"));
    }
    ...
    protected void doFilterInternal(
        ...
        if (providedKey == null || !providedKey.equals(internalGatewayKey)) {
            log.warn("Blocked vision request without valid gateway trust key: method={} path={} ip={}",
