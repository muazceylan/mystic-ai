package com.mysticai.spiritual.security;
...
public class GatewayTrustFilter extends OncePerRequestFilter {
    ...
    public GatewayTrustFilter(MeterRegistry meterRegistry) {
        this.rejectedGatewayTrustCounter = Counter.builder("security.spiritual.gateway_trust_rejected")
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !path.startsWith("/api/v1/spiritual/");
    }
    ...
    protected void doFilterInternal(
        ...
        if (providedKey == null || !providedKey.equals(internalGatewayKey)) {
            log.warn("Blocked spiritual request without valid gateway trust key: method={} path={} ip={}",
